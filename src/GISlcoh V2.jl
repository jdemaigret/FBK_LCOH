...
function GISlcoh(; savetodisk=false, plotmasks=false, optionlist...)
   ...
   avg_offshore_dist_1, avg_offshore_dist_2, avg_offshore_dist_3, avg_offshore_dist_4, avg_offshore_dist_5 = calculate_mean_CF(loptions, regions, lonrange, latrange, solarGTI, windspeed, mask_pv_lcoh, mask_onshore_lcoh, mask_offshore_lcoh,pv_system_efficiency)
    ...
    filename0 = in_datafolder("output", "$gisregion results_matrix V11 (Spin8T).txt");
    filename1 = in_datafolder("output", "$gisregion charachteristic_cf_curves V11 (Spin8T).txt");
    filename2 = in_datafolder("output", "$gisregion max_and_min_CF V11 (Spin8T).txt");
    filename3 = in_datafolder("output", "$gisregion Caps CF sums and averagesV11 (Spin8T).txt");
    filename4 = in_datafolder("output", "$gisregion Areas and Potentials V11 (Spin8T).txt");
    filename5 = in_datafolder("output", "$gisregion LCOEs V11 (Spin8T).txt");
...
function iterative_find_min_3var(loptions, CF_pvplant, max_capacity_pv,
    ...
    for l in 1:length(dd)
        ...
        d=dd[l];
        LCOH_min0=LCOH_min
        println("LCOH_min all'iterazione (type_min=1) $l : $LCOH_min")
        # println("\nIter: $l");
        # println("\nstartvalue_pv");
        ...
        (abs(LCOH_min0-LCOH_min) < 0.05) && continue
...
function iterative_find_min_2var(loptions, CF_pvplant, max_capacity_pv,
    ...
    if type_min == 2 #solo pv
        ...
        for l in 1:length(dd)
            ...
            LCOH_min0=LCOH_min
            println("LCOH_min all'iterazione (type_min=2) $l : $LCOH_min")
    ...
    if type_min == 3 #solo wind onshore
        ...
        for l in 1:length(dd)
            ...
            LCOH_min0=LCOH_min
            println("LCOH_min all'iterazione (type_min=3) $l : $LCOH_min")
    ...
    if type_min == 4 #solo wind offshore
        ...
        for l in 1:length(dd)
            ...
            LCOH_min0=LCOH_min
            println("LCOH_min all'iterazione (type_min=4) $l : $LCOH_min")
...
function calculate_LCOE(gisregion, WACC_value)
    ...
    #---------------------------------------------------------------------------
        ...
        for t in 1:lifetime_wind
            annual_cost_onshore_1[t] = ((CAPEX_wind_onshore/lifetime_wind) + (OPEX_wind_onshore*CAPEX_wind_onshore)) / (1+WACC_onshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_onshore_2[t] = ((CAPEX_wind_onshore/lifetime_wind) + (OPEX_wind_onshore*CAPEX_wind_onshore)) / (1+WACC_onshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_onshore_3[t] = ((CAPEX_wind_onshore/lifetime_wind) + (OPEX_wind_onshore*CAPEX_wind_onshore)) / (1+WACC_onshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_onshore_4[t] = ((CAPEX_wind_onshore/lifetime_wind) + (OPEX_wind_onshore*CAPEX_wind_onshore)) / (1+WACC_onshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_onshore_5[t] = ((CAPEX_wind_onshore/lifetime_wind) + (OPEX_wind_onshore*CAPEX_wind_onshore)) / (1+WACC_onshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_offshore_1[t] = ((CAPEX_wind_offshore/lifetime_wind) + (OPEX_wind_offshore*CAPEX_wind_offshore)) / (1+WACC_offshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_offshore_2[t] = ((CAPEX_wind_offshore/lifetime_wind) + (OPEX_wind_offshore*CAPEX_wind_offshore)) / (1+WACC_offshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_offshore_3[t] = ((CAPEX_wind_offshore/lifetime_wind) + (OPEX_wind_offshore*CAPEX_wind_offshore)) / (1+WACC_offshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_offshore_4[t] = ((CAPEX_wind_offshore/lifetime_wind) + (OPEX_wind_offshore*CAPEX_wind_offshore)) / (1+WACC_offshore)^t ;
        ...
        for t in 1:lifetime_wind
            annual_cost_offshore_5[t] = ((CAPEX_wind_offshore/lifetime_wind) + (OPEX_wind_offshore*CAPEX_wind_offshore)) / (1+WACC_offshore)^t ;
