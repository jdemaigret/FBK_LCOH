...
#New function
function create_pv_mask(options, regions, popdens, land, protected, lonrange, latrange; plotmasks=false, downsample=1)
    @unpack res, gisregion, exclude_landtypes, protected_codes, plant_persons_per_km2,
            filenamesuffix = options
...
#New function
function calc_pv_cf(options, meanGTI, solarGTI, pv_area, regions, offshoreregions, regionlist,
    ...
    @unpack era_year, res, erares, pv_density, plant_area = options
...
function calc_area(options, regions, offshoreregions, regionlist,
                mask_pv, lonrange, latrange)
    ...
    @unpack era_year, res, erares, plant_area = options
        ...
        for i = 1:nlons
            ...
            for c in colrange, r in rowrange
                ...
                if mask_pv[r,c] > 0
                    ...
                    #inserire qui anche calcolo aree utili per wind
                end
