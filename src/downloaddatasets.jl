using BinDeps,GlobalEnergyGIS_lcoh

export download_datasets

function download_datasets(startfile=1)
    datafolder = GlobalEnergyGIS.getconfig("datafolder")
    if !isfile(datafolder)
        mkpath(datafolder)
    end

    #WDPA_filename = "WDPA_Apr2021_Public_shp"
    WDPA_filename = "WDOECM_Apr2021_Public_shp"
    ...
    datasets = [
        ...
        ("WDPA (protected areas):", "WDPA.zip",
            #"https://d1gam3xoknrgr2.cloudfront.net/current/WDPA_Apr2021_Public_shp.zip"),
            "https://d1gam3xoknrgr2.cloudfront.net/current/WDOECM_Apr2021_Public_shp.zip"),
            #"https://d1gam3xoknrgr2.cloudfront.net/current/WDPA_WDOECM_Apr2021_Public_feadb1b4f30799a6dc3ad0b16116d3530ec4a477898f4e10e097e2030e167128.zip"),
