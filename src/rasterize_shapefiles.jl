...
export rasterize, readraster, saveTIFF#, slope1
...
# function reaster_prova ()
#
#     slope = ArchGDAL.read(in_datafolder("slope_1KMmd_GMTEDmd.tif"))
#
#
#
#     JLD.save(in_datafolder("slope.jld"), "slope", slope, "slopevalues", slopevalues, compress=true)
#     return slope
# end
