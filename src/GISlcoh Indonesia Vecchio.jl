...
function calc_LCOH_CAPS_PROD(loptions, regions, solarGTI, offshoreregions, regionlist, mask_pv_lcoh,
    ...
    CAPEX_pv               = CAPEX_and_WACC[12,1];
    CAPEX_wind_onshore     = CAPEX_and_WACC[12,2];
    CAPEX_wind_offshore    = CAPEX_and_WACC[12,3];

    if WACC_value == "Variable_WACC"
        WACC_pv       = CAPEX_and_WACC[12,4];
        WACC_onshore  = CAPEX_and_WACC[12,5];
        WACC_offshore = CAPEX_and_WACC[12,6];
    else
        WACC_pv       = WACC_value
...
function iterative_find_min_3var(loptions, CF_pvplant, max_capacity_pv,
    ...
    return x_min_LCOH_rescaled, y_onshore_min_LCOH_rescaled, z_min_LCOH_rescaled, LCOH_min, rescaled_annual_hydrogen_production, LCOE_min
end
...
function iterative_find_min_2var(loptions, CF_pvplant, max_capacity_pv,
    ...
    return x_min_LCOH_rescaled, y_onshore_min_LCOH_rescaled, y_offshore_min_LCOH_rescaled, z_min_LCOH_rescaled, LCOH_min, rescaled_annual_hydrogen_production, LCOE_min
end
